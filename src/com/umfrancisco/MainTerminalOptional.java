...
public class MainTerminalOptional {
	public static void main(String[] args) {
		...
		students.stream()
			...
			.findAny()
			.ifPresentOrElse(s -> System.out.printf("Student %d from %s is %d\n", s.getStudentId(), s.getCountryCode(), s.getAge()), 
		...
		students.stream()
			...
			.average()
			.ifPresentOrElse(a -> System.out.printf("Avg age under 21: %.2f%n", a), () -> System.out.println("Didn't find anyone under "+minAge));
